            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-2 gap-3 mb-4">
                    <div class="bg-blue-50 dark:bg-gray-700 rounded-lg p-3">
                        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ $purana->total_chapters }}</div>
                        <div class="text-xs text-gray-600 dark:text-gray-400">Chapters</div>
                    </div>
                    <div class="bg-blue-50 dark:bg-gray-700 rounded-lg p-3">
                        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ number_format($purana->total_verses) }}</div>
                        <div class="text-xs text-gray-600 dark:text-gray-400">Verses</div>
                    </div>
                </div>

                <!-- Action Button -->
                <a href="{{ route('puranas.show', $purana->purana_number) }}" class="block w-full bg-orange-600 hover:bg-amber-600 text-white text-center py-2 rounded-lg font-semibold transition text-sm">
                    View Purana
                </a>
            </div>
        </div>
