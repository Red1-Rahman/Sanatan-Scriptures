    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div class="grid grid-cols-2 gap-6 mb-8">
            <div class="bg-blue-50 dark:bg-gray-700 rounded-lg p-6">
                <div class="text-4xl font-bold text-navy-700 dark:text-blue-400">{{ $chapters->count() }}</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Available Chapters</div>
            </div>
            <div class="bg-blue-50 dark:bg-gray-700 rounded-lg p-6">
                <div class="text-4xl font-bold text-navy-700 dark:text-blue-400">{{ $chapters->sum('verse_count') }}</div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="bg-blue-50 dark:bg-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow">
                    <div class="text-xl font-bold text-navy-700 dark:text-blue-400">Chapter {{ $chapterInfo->chapter }}</div>
                    <div class="text-sm text-gray-600 dark:text-gray-400">{{ $chapterInfo->verse_count }} verses</div>
                </div>
                @endforeach
            </div>
        </div>
